...
class Settings(BaseSettings):
    ...
    workspace_summary_model: str | None = Field(default=None, validation_alias=env_alias("WORKSPACE_SUMMARY_MODEL"))
    workspace_summary_max_chars: int = Field(default=120_000, ge=12000, le=500_000, validation_alias=env_alias("WORKSPACE_SUMMARY_MAX_CHARS"))
    allow_paid_fallback: bool = Field(default=False, validation_alias=env_alias("ALLOW_PAID_FALLBACK"))
