...
export class SMCWorkspace extends (globalThis.HTMLElement ?? class {}) {
  ...
  get base() {
    return resolveApiBase(this.getAttribute("api-base") || "/api/v1/workspace");
  }
...
if (globalThis.customElements && !customElements.get("smc-workspace"))
